...
class Container implements ContainerInterface, ArrayAccess, IteratorAggregate, Countable
{
    ...
    protected function bindParams(ReflectionFunctionAbstract $reflect, array $vars = [])
    {
        ...
        foreach ($params as $param) {
            ...
            $reflectionType = $param->getClass();

            if ($param->isVariadic()) {
                return array_merge($args, array_values($vars));
            } elseif ($reflectionType && $reflectionType instanceof \ReflectionClass && $reflectionType->isUserDefined()) {
