...
class RuleItem extends Rule
{
     ...
     */
    public function __construct(Route $router, RuleGroup $parent, $name = null, $rule = '', $route = null, $method = '*')
    {
        $this->router = $router;
        $this->parent = $parent;
        $this->name   = $name;
     ...
     */
    public function checkRule(Request $request, $url, $match = null, $completeMatch = false)
    {
        // 检查参数有效性
