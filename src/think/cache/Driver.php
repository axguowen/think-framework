...
abstract class Driver implements CacheInterface, CacheHandlerInterface
{
    ...
    protected function serialize($data)
    {
        ...
        $serialize = isset($this->options['serialize'][0]) ? $this->options['serialize'][0] : "serialize";
    ...
    protected function unserialize($data)
    {
        ...
        $unserialize = isset($this->options['serialize'][1]) ? $this->options['serialize'][1] : "unserialize";
