...
class App extends Container
{
    ...
    public function getService($service)
    {
        ...
        $serviceValues = array_values(array_filter($this->services, function ($value) use ($name) {
            return $value instanceof $name;
        }, ARRAY_FILTER_USE_BOTH));
        // 返回
        return isset($serviceValues[0]) ? $serviceValues[0] : null;
    }
    ...
    {
        return realpath(dirname($this->thinkPath) . '/../../../') . DIRECTORY_SEPARATOR;
    }
