...
interface ModelRelationInterface
{
     ...
     * @return integer
     */
    public function relationCount(Model $result, Closure $closure, $aggregate = 'count', $field = '*', &$name = null);
     ...
     * @return string
     */
    public function getRelationCountQuery(Closure $closure = null, $aggregate = 'count', $field = '*', &$name = null);
