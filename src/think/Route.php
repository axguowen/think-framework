...
class Route
{
     ...
     * @return string|null
     */
    public function getDomainBind($domain = null)
    {
        if (is_null($domain)) {
            $domain = $this->host;
     ...
     * @return $this
     */
    public function setCrossDomainRule(Rule $rule, $method = '*')
    {
        if (!isset($this->cross)) {
     ...
     */
    public function resource($rule, $route)
    {
     ...
     * @return RuleItem
     */
    public function redirect($rule, $route = '', $status = 301)
    {
